...
function bindControls() {
    const darkModeInput = l("darkModeInput");
    if (darkModeInput) {
        darkModeInput.onchange = () => changeTheme(darkModeInput);
    }
    const gamMode = l("gamMode");
    if (gamMode) {
...
function bindCookieConsent() {
    ...
    const settingsInput = l("consentSettings");
    const analyticsInput = l("consentAnalytics");
    ...
    ;
    acceptAll.onclick = () => {
        const consent = { settings: true, analytics: true };
    ...
    ;
    rejectAll.onclick = () => {
        const consent = { settings: false, analytics: false };
        saveCookieConsent(consent);
        applyCookieConsent(consent);
        popup.classList.add("hidden");
    };
...
function getStoredJSON(key, data) {
    if (data?.key && localStorage[key] !== "null") {
        try {
            const inStore = JSON.parse(localStorage[key]);
            if (typeof inStore === "object" &&
...
function setSavedTheme() {
    ...
    if (!darkModeInput)
        return;
    const gamModeSelect = l("gamMode");
    if (gamModeSelect) {
        gamModeSelect.value =
            getStoredJSON("gams", { key: "gamMode" }) || "embed";
    }
    const savedTheme = getStoredJSON("gams", { key: "theme" });
    if (savedTheme === "light") {
        setLight();
...
if (shadeElm) {
    shadeElm.onclick = () => {
        ...
        const mainGam = l("mainGam");
        const newWin = l("newWin");
        if (overlay)
...
const gamsList = [
    ...
    { name: "Stickman Hook" },
    { name: "Drive Mad", href: "games/games/drivemad/drivemad.html" },
    { name: "2048" },
    { name: "Cookie Clicker", href: "games/games/cookie/index.html" },
    { name: "Cube Field", href: "games/games/cubefield/index.html" },
    ...
    { name: "Wordle" },
    { name: "Paper IO 2" },
    { name: "Aim Trainer", href: "games/games/aimtrainer/aimtrainer.html" },
    { name: "Snake", href: "games/snake.html" },
    { name: "Slope" },
    { name: "Burrito Bison", href: "games/games/burritobison/burritobison.html" },
    { name: "Tube Jumpers" },
    { name: "Hole IO" },
    { name: "Madalin Stunt Cars", href: "games/games/madalinstuntcars/madalinstuntcars.html" },
    { name: "Glass City", href: "games/games/glasscity/glasscity.html" },
    { name: "Tunnel Rush", href: "games/games/tunnelrush/tunnelrush.html" },
    { name: "Tanuki Sunset", href: "games/games/tanukisunset/tanukisunset.html" },
    { name: "A Dance of Fire and Ice", href: "games/games/fireice/index.html" },
    { name: "Game Inside a Game", href: "games/games/gameinsideagame/index.html" },
    { name: "Cell Machine", href: "games/games/cellmachine/index.html" },
    { name: "Slope 2", href: "games/games/slope2/index.html" },
    { name: "Ai Creatures", href: "games/games/aicreatures/index.html" },
    { name: "Grey Box Testing", href: "games/games/greybox/index.html" },
    { name: "Drift Boss", href: "games/games/driftboss/driftboss.html" },
    { name: "Chess", href: "games/chess.html" },
    { name: "Subway Surfers", href: "games/games/subwaysurf/subwaysurf.html" },
    ...
    { name: "Worlds Hardest Game" },
    {
        ...
        href: "games/games/Ruffle/player.html?swf=../../flash/whg2.swf",
    },
    ...
    { name: "Duck Life 4" },
    { name: "Duck Life 5" },
    { name: "Run", href: "games/games/Ruffle/player.html?swf=../../flash/run.swf" },
    { name: "Run 2", href: "games/games/Ruffle/player.html?swf=../../flash/run-2.swf" },
    { name: "Run 3", href: "games/games/Ruffle/player.html?swf=../../flash/run3.swf" },
    { name: "doom", href: "games/games/Ruffle/player.html?swf=../../flash/doom.swf" },
    { name: "Johnny Upgrade", href: "games/games/Ruffle/player.html?swf=../../flash/john.swf" },
    {
        name: "Papas Burgeria",
        href: "games/games/Ruffle/player.html?swf=../../flash/papasburgeria.swf",
    },
    {
        name: "Fireboy And Watergirl 1",
        href: "games/games/Ruffle/player.html?swf=../../flash/fbwg1.swf",
    },
    {
        name: "Papas Pastaria",
        href: "games/games/Ruffle/player.html?swf=../../flash/papaspastaria.swf",
    },
    { name: "Portal", href: "games/games/Ruffle/player.html?swf=../../flash/portal.swf" },
    { title: "Tools", type: "section" },
    { name: "Ruffle Flash Player", href: "games/games/Ruffle/Ruffle.html" },
    { name: "Code Editor", type: "raw" },
    { name: "Web Retro" },
    { name: "Proxy Browser", href: "games/proxybrowser.html" },
    { name: "Calculator", href: "games/calc.html" },
];
function setCookie(name, value, days) {
    if (!hasSettingsCookieConsent())
        return;
    let expires = "";
    if (days) {
        const date = new Date();
...
if (totalGamesEl)
    totalGamesEl.innerText = String(totalGames);
const container = createElement("div", { id: "container" });
const containEl = l("contain");
if (containEl)
    containEl.appendChild(container);
...
const ogIcon = ogIconEl ? ogIconEl.href : "";
function applyDisguise() {
    const icon = getStoredJSON("gams", { key: "icon" });
    const title = getStoredJSON("gams", { key: "title" });
